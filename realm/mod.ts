 ...
 *
 * > **NOTE**: This module is based on the [`ShadowRealm`](https://github.com/tc39/proposal-shadowrealm)
 * > API proposal but does not follow the specifications.
 *
 * > **WARNING**: This module is basically a bunch of hacks to get the desired
 * > functionality. So expect warts and all. ESPECIALLY regarding things like line
 * > numbering or errors.
 *
